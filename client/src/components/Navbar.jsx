            ...
            <div className="px-4 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3 pl-2">
                        ...
                        <div className="w-10 h-10 rounded-[var(--radius-full)] bg-[var(--color-tertiary-sage)] flex items-center justify-center shadow-sm overflow-hidden capitalize text-[var(--color-primary-navy)] font-bold">
