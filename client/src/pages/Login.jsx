        ...
        <div className="min-h-screen flex items-center justify-center bg-slate-950 text-white relative overflow-hidden">
            ...
            <div className="max-w-md w-full p-8 bg-slate-900/50 backdrop-blur-xl border border-slate-800 rounded-3xl shadow-2xl relative z-10">
                <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center p-4 bg-gray-400 rounded-2xl mb-4 border border-blue-500/30">
                        {/* <GraduationCap className="w-10 h-10 text-blue-400" /> */}
                        <img src="/dj-science-college-logo.png" alt="Logo" className="w-10 h-10" />
                    </div>
